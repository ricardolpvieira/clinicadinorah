...
import { FileText, Clipboard, Stethoscope, Headphones } from "lucide-react"
...
const relatedServices = [
  ...
  },
  {
    ...
    description: "Avaliação auditiva e Programa de Conservação Auditiva.",
    icon: <Headphones className="h-6 w-6 text-sky-600" />,
    href: "/servicos/medicina-do-trabalho/audiometria-pca",
  },
]

export default function RelatedServicesErgonomia() {
  return (
